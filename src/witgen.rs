...
///     output_path: "wit/components.wit".into(),
///     ..Default::default()
/// };
/// ```
pub struct WitGeneratorSettings {
    ...
    ///
    /// Defaults to "my-namespace:my-game"
    pub package: String,

    /// Interface name that contains the component resources.
    ///
    /// Defaults to "components"
    pub component_interface: String,
    ...
    ///
    /// Defaults to "wit/game-bingings.wit"
...
fn write_wit(
    ...
    bevy_log::info!("Wrote WIT file to: {:?}", settings.output_path);
}
...
fn render_wit(
    ...
    out.push_str("/// These bindings are automatically generated by wasvy");
    out.push_str(&format!("package {};\n\n", settings.package));
    out.push_str(&format!("interface {} {{\n", settings.component_interface));
