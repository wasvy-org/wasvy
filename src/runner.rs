        ...
        F: FnMut(&mut Store) -> R,
    {
        self.store.data_mut().set_data(Data(match config {
            ...
            Config::RunSystem(ConfigRunSystem {
                ...
                method_registry: SendSyncPtr::new(NonNull::from_ref(method_registry)),
...
enum Inner {
    ...
    RunSystem {
        ...
        method_registry: SendSyncPtr<MethodRegistry>,
        ...
        match &mut self.0 {
            ...
            unsafe {
                Some(State::RunSystem {
                    ...
                    method_registry: method_registry.as_ref(),
...
pub(crate) struct ConfigRunSystem<'a, 'b, 'c, 'd, 'e, 'f, 'g> {
    ...
    pub(crate) method_registry: &'a MethodRegistry,
    pub(crate) queries:
